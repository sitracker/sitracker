...
$strReportDescFeedback = 'Reports on the feedback received from customers and can be filtered by engineer, contactm site or product';
...
$strReportDescIncidentsBillable = 'List of all billable incidents between two optional datess';
