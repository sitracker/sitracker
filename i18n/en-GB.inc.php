...
$strEditIncidentType = 'Edit Incidents Type';
$strEditKBArticle = 'Edit Knowledge Base Article';
$strEditLicenseType = 'Edit Licence Type';
...
# help for strIncidentLogOrder config option
$strIncidentLogOrderHelp = 'Choose \'asc\' for Ascending (oldest first), or \'desc\' for Descending (newest first)';
...
$strIncidentTypes = 'Incident Types';
$strIncidentType = 'Incident Type';
...
$strIncidentOwnersManagersFullName = 'Full name of the person who owns the incident manager';
$strIncidentOwnersEmail = 'Email address of the incident owner';
$strIncidentOwnersManagerEmail = 'Email address of the incident owner\'s manager';
$strIncidentsUsed = 'Incidents Used';
$strIncidentTemporaryOwner = 'Incident temporary owner';
$strIncidentTemporaryOwnersFullName = 'Full name of the person who temporarily owns the incident';
$strIncidentTemporaryOwnersEmail = 'Email address of the incident temporary owner';
...
$strNewIncidentType = 'New Incident Type';
$strNewIncidentStatus = 'New Incident Status';
$strNewKBArticle = 'New Article';
$strNewLicenseType = 'New Licence Type';
$strNewLink = 'New Link';
...
$strNotificationsAwayHelp = 'Which notifications to receive when your status is set to \'Not in Office\', \'Absent Sick\', \'On Holiday\' or \'Working Away\'';
...
$strNotifyMinutes = 'Notify Minutes';
...
$strParametersX = '<strong>Parameters</strong>: %s';
...
$strReportDescCustomers = 'Export details of the customers including contact details and products';
$strReportDescFeedback = 'Reports on the feedback received from customers and can be filtered by engineer, contact, site or product';
$strReportDescIncidentsAverageDuration = 'Displays on a monthly basis the average duration (time open) for an incident including number of updated and engineers working the incidents';
$strReportDescIncidentsBillable = 'List of all billable incidents between two optional dates';
$strReportDescIncidentsByCustomer = 'List number of incidents opened by sites in a given time period';
$strReportDescIncidentsByEngineer = 'List all incidents handled by an engineer in a given time period';
$strReportDescIncidentsBySite = 'List all incidents opened by a site, listing incident title, ID and customer contact';
$strReportDescIncidentsBySkill = 'Shows a break down of the number of incidents logged by skill and SLA in a given time period';
$strReportDescIncidentsByVendor = 'List the number of incidents for each vendor';
$strReportDescIncidentsDailySummary = 'Displays a day by day breakdown of the incidents logged and who they where assigned to';
$strReportDescIncidentsEscalated = 'Shows how incidents are distributed by extenernal engineer, this uses the external engineer name field';
$strReportDescIncidentsGraph = 'Displays the number of incidents opened and closed over the course of a year with the ability to look at previous years';
$strReportDescIncidentsRecent = 'Lists all incidents opened in the previous month';
$strReportDescMarketting = 'Export list of contact details based on site filters';
$strReportDescOrphansContacts = 'Show contacts which are not associated with an existing site';
$strReportDescQBE = 'Query By Example to directly query the database tables';
$strRepository = 'Repository';
$strRequestClosure = 'Request Closure';
$strRequested = 'Requested';
$strRequestClosureViaThePortalBy = 'Requested closure via the portal by';
$strRequestNoUsersToApprovePermissions = 'There are no users that can approve your request, only users with appropriate permissions can approve holiday requests and you cannot approve your own requests.';
...
$strSession = 'Session';
$strSessionExpired = 'Your session has expired, please login to continue';
...
$strSetSkills = 'Set skills';
$strSetSubstitutes = 'Set substitutes';
...
$strShowConfirmationMessagesOnDelete = 'Show confirmation messages ("Are you sure?") on delete';
$strShowConfirmationBeforeClosingAWindows = 'Show confirmation before closing a Window';
...
$strShowNextActionHelp = 'Show an incident\'s next action in the incident table';
...
$strSorryNoSearchResults = 'Sorry, your search yielded no results';
...
$strTriggerPortalIncidentRequestClosed = 'When an incident is requested to be closed';
...
$strUnableToChangeServiceAsUsed = 'Unable to change the credit amount or unit rates as transactions have already been recorded against the service (current balance does not equal the credeit balance) either through incidents or one time updates.';
...
$strUrgent = 'Urgent';
$strUseASingleWindowForIncidentDetails = 'Use a single window for incident details';
$strUsed = 'Used';
