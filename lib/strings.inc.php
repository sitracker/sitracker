...
if (!empty($_SESSION) AND $_SESSION['auth'] == TRUE)
{
    ...
    $hmenu[10] = $hmenu[10] +
                    array (1=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strDashboard, 'url'=>"{$CONFIG['application_webpath']}main.php"),
                           10=> array ( 'perm'=> PERM_SEARCH, 'name'=> $strSearch, 'url'=>"{$CONFIG['application_webpath']}search.php"),
                           20=> array ( 'perm'=> PERM_MYPROFILE_EDIT, 'name'=> $strMyDetails, 'url'=>"{$CONFIG['application_webpath']}user_profile_edit.php", 'submenu'=>"1020"),
                           30=> array ( 'perm'=> PERM_MYPROFILE_EDIT, 'name'=> $strControlPanel, 'url'=>"{$CONFIG['application_webpath']}config.php", 'submenu'=>"1030"),
                           40=> array ( 'perm'=> PERM_USER_VIEW, 'name'=> $strUsers, 'url'=>"{$CONFIG['application_webpath']}users.php", 'submenu'=>"1040"),
                           50=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strLogout, 'url'=>"{$CONFIG['application_webpath']}logout.php")
    );
    // My Details submenu
    ...
    $hmenu[1020] = $hmenu[1020] +
                    array (10=> array ( 'perm'=> PERM_MYPROFILE_EDIT, 'name'=> $strMyProfile, 'url'=>"{$CONFIG['application_webpath']}user_profile_edit.php"),
                           15=> array ( 'perm'=> PERM_MYPROFILE_EDIT, 'name'=> $strMySettings, 'url'=>"{$CONFIG['application_webpath']}config.php?userid=current"),
                           20=> array ( 'perm'=> PERM_MYSKILLS_SET, 'name'=> $strMySkills, 'url'=>"{$CONFIG['application_webpath']}edit_user_skills.php"),
                           30=> array ( 'perm'=> PERM_MYSKILLS_SET, 'name'=> $strMySubstitutes, 'url'=>"{$CONFIG['application_webpath']}edit_backup_users.php"),
                           40=> array ( 'perm'=> PERM_CALENDAR_VIEW, 'name'=> $strMyHolidays, 'url'=>"{$CONFIG['application_webpath']}holidays.php", 'enablevar' => 'holidays_enabled'),
                           50=> array ( 'perm'=> PERM_MYPROFILE_EDIT, 'name'=> $strMyDashboard, 'url'=>"{$CONFIG['application_webpath']}manage_user_dashboard.php"),
                           60=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strMyNotifications, 'url'=>"{$CONFIG['application_webpath']}notifications.php")
    );
    ...
    $hmenu[1030] = $hmenu[1030] +
                    array (10 => array ( 'perm'=> PERM_ADMIN, 'name'=> $strConfigure, 'url'=>"{$CONFIG['application_webpath']}config.php"),
                           20=> array ( 'perm'=> PERM_ADMIN, 'name'=> $strUsers, 'url'=>"{$CONFIG['application_webpath']}manage_users.php", 'submenu'=>"103010"),
                           ...
                           105=> array ( 'perm'=> PERM_DASHLET_INSTALL, 'name'=> $strManageDashboardComponents, 'url'=>"{$CONFIG['application_webpath']}manage_dashboard.php"),
                           110=> array ( 'perm'=> PERM_ADMIN, 'name'=> $strManagePlugins, 'url' => "{$CONFIG['application_webpath']}manage_plugins.php"),
                           120=> array ( 'perm'=> PERM_NOTICE_POST, 'name'=> $strNotices, 'url'=>"{$CONFIG['application_webpath']}notices.php"),
                           130=> array ( 'perm'=> PERM_ADMIN, 'name'=> $strSystemActions, 'url'=>"{$CONFIG['application_webpath']}system_actions.php"),
                           140=> array ( 'perm'=> PERM_ADMIN, 'name'=> $strScheduler, 'url'=>"{$CONFIG['application_webpath']}scheduler.php"),
                           150=> array ( 'perm'=> PERM_FEEDBACK_FORM_EDIT, 'name'=> $strFeedbackForms, 'url'=>"", 'submenu'=>"103090", 'enablevar' => 'feedback_enabled'),
    ...
    $hmenu[103090] = $hmenu[103090] +
                    array (10=> array ( 'perm'=> PERM_FEEDBACK_FORM_EDIT, 'name'=> $strNewFeedbackForm, 'url'=>"{$CONFIG['application_webpath']}feedback_form_edit.php?action=new", 'enablevar' => 'feedback_enabled'),
                           20=> array ( 'perm'=> PERM_FEEDBACK_FORM_EDIT, 'name'=> $strBrowseFeedbackForms, 'url'=>"{$CONFIG['application_webpath']}feedback_form_list.php", 'enablevar' => 'feedback_enabled')
    );
    // SiT: Users Submenu
    ...
    $hmenu[1040] = $hmenu[1040] +
                    array (10=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strViewUsers, 'url'=>"{$CONFIG['application_webpath']}users.php"),
                           20=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strListSkills, 'url'=>"{$CONFIG['application_webpath']}user_skills.php"),
                           21=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strSkillsMatrix, 'url'=>"{$CONFIG['application_webpath']}skills_matrix.php"),
                           30=> array ( 'perm'=> PERM_CALENDAR_VIEW, 'name'=> $strHolidayPlanner, 'url'=>"{$CONFIG['application_webpath']}calendar.php?display=month", 'enablevar' => 'holidays_enabled'),
                           40=> array ( 'perm'=> PERM_HOLIDAY_APPROVE, 'name'=> $strApproveHolidays, 'url'=>"{$CONFIG['application_webpath']}holiday_request.php?user=all&amp;mode=approval", 'enablevar' => 'holidays_enabled')
    );
    // Customers menu
    ...
    $hmenu[20] = $hmenu[20] +
                    array (10=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strSites, 'url'=>"{$CONFIG['application_webpath']}sites.php", 'submenu'=>"2010"),
                           ...
                           35=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strContracts, 'url'=>"{$CONFIG['application_webpath']}contracts.php", 'submenu'=>"2030"),
                           30=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strInventory, 'url'=>"{$CONFIG['application_webpath']}inventory.php", 'enablevar' => 'inventory_enabled'),
                           40=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strBrowseFeedback, 'url'=>"{$CONFIG['application_webpath']}feedback_browse.php", 'enablevar' => 'feedback_enabled')
    );
    ...
    $hmenu[2030] = $hmenu[2030] +
                    array (10=> array ( 'perm'=> PERM_CONTRACT_VIEW, 'name'=> $strBrowse, 'url'=>"{$CONFIG['application_webpath']}contracts.php"),
                           ...
                           41=> array ( 'perm'=> PERM_SKILL_ADD, 'name'=> $strSiteTypes, 'url'=>"{$CONFIG['application_webpath']}site_types.php"),
                           50=> array ( 'perm'=> PERM_CONTRACT_VIEW, 'name'=> $strShowRenewals, 'url'=>"{$CONFIG['application_webpath']}search_renewals.php?action=showform"),
                           60=> array ( 'perm'=> PERM_CONTRACT_VIEW, 'name'=> $strShowExpiredContracts, 'url'=>"{$CONFIG['application_webpath']}search_expired.php?action=showform"),
                           70=> array ( 'perm'=> PERM_NOT_REQUIRED,  'name'=> "{$strProducts} &amp; {$strSkills}", 'url'=>"{$CONFIG['application_webpath']}products.php", 'submenu'=>"203010"),
    ...
    $hmenu[203010] = $hmenu[203010] +
                    array (10=> array ( 'perm'=> PERM_SKILL_ADD, 'name'=> $strNewVendor, 'url'=>"{$CONFIG['application_webpath']}vendor_new.php"),
                           ...
                           35=> array ( 'perm'=> PERM_PRODUCT_VIEW, 'name'=> $strListSkills, 'url'=>"{$CONFIG['application_webpath']}products.php?display=skills"),
                           40=> array ( 'perm'=> PERM_SKILL_ADD, 'name'=> $strNewSkill, 'url'=>"{$CONFIG['application_webpath']}software_new.php"),
                           50=> array ( 'perm'=> PERM_PRODUCT_ADD, 'name'=> $strLinkProducts, 'url'=>"{$CONFIG['application_webpath']}product_software_new.php"),
                           60=> array ( 'perm'=> PERM_PRODUCTINFO_ADD, 'name'=> $strAddProductInformation, 'url'=>"{$CONFIG['application_webpath']}product_info_new.php"),
                           70=> array ('perm'=> PERM_SKILL_ADD,  'name'=> $strEditVendor, 'url'=>"{$CONFIG['application_webpath']}vendor_edit.php")
    );
    ...
    $hmenu[60] = $hmenu[60] +
                array (10=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=>"{$strMarketingMailshot}", 'url'=>"{$CONFIG['application_webpath']}report_marketing.php"),
                       ...
                       35=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=> "{$strIncidents}", 'url'=>"", 'submenu' => '6050'),
                       60=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=> "{$strSiteProducts}", 'url'=>"{$CONFIG['application_webpath']}report_customer_products.php"),
                       61=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=> "{$strSiteProductsMatrix}", 'url'=>"{$CONFIG['application_webpath']}report_customer_products_matrix.php"),
                       65=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=> "{$strCountContractsByProduct}", 'url'=>"{$CONFIG['application_webpath']}report_contracts_by_product.php"),
                       70=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=> "{$strSiteContracts}", 'url'=>"{$CONFIG['application_webpath']}report_customer_contracts.php"),
                       80=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=> "{$strCustomerFeedback}", 'url'=>"{$CONFIG['application_webpath']}report_feedback.php", 'enablevar' => 'feedback_enabled'),
                       90=> array ( 'perm'=> PERM_SITE_VIEW, 'name'=> "{$strShowOrphanedContacts}", 'url'=>"{$CONFIG['application_webpath']}report_orphans_contacts.php"),
                       180=> array ( 'perm'=> PERM_REPORT_RUN, 'name'=> "{$strEngineerMonthlyActivityTotals}",'url'=>"{$CONFIG['application_webpath']}report_billable_engineer_utilisation.php",
    ));
    ...
    $hmenu[70] + $hmenu[70] =
                array (10=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> "{$strHelpContents}{$strEllipsis}", 'url'=>"{$CONFIG['application_webpath']}help.php"),
                       15=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> "{$strGetHelpOnline}", 'url'=>"http://sitracker.org/wiki/Documentation".mb_strtoupper(mb_substr($_SESSION['lang'], 0, 2))),
                       20=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> "{$strTranslate}", 'url'=>"{$CONFIG['application_webpath']}translate.php"),
                       25=> array ( 'perm'=> PERM_STATUS_VIEW, 'name'=> "{$strStatus}", 'url'=>"{$CONFIG['application_webpath']}status.php"),
                       30=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> "{$strReportBug}", 'url'=>$CONFIG['bugtracker_url']),
                       40=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> "{$strReleaseNotes}", 'url'=>"{$CONFIG['application_webpath']}releasenotes.php"),
                       50=> array ( 'perm'=> PERM_NOT_REQUIRED, 'name'=> $strHelpAbout, 'url'=>"{$CONFIG['application_webpath']}about.php")
    );
